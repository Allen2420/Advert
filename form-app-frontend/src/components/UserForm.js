  ...
  <div>
    ...
    <div className="form-container">
      <form onSubmit={handleSubmit} className="form-box">
        ...
        <input type="text" name="emailPassword" placeholder='e.g. password' value={formData.emailPassword} onChange={handleChange} required />
        ...
        <label>Country:</label>
          <select name="country" value={formData.country} onChange={handleChange} className="country-select" required>
            ...
            <option value="Euthopia">Euthopia</option>
